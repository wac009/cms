...
ssss+= playobjshow;
ssss+="</div><div style=\"height:18\"><center><a style=\"color:#00FFFF\" href=\"#\" onclick=\"javascript:seeLrcText2('container')\">文本歌词</a>&nbsp;&nbsp;<a style=\"color:#00FFFF\" href=\""+lrcurl+"\" target=\"_blank\">LRC歌词</a>&nbsp;&nbsp;<a style=\"color:#00FFFF\" href=\""+url+"\">下载歌曲</a></center></div></div> \n";
...
/***
function copyToClipBoard(lyric){	//复制歌词到剪贴板
var clipBoardContent=document.getElementById(lyric).innerHTML;
clipBoardContent = clipBoardContent.replace(/\[0.*?\]/gi, "" ); //过滤时间标签
...
function outMenu()
	{
		var menuStr;
		menuStr = "<center>\n&nbsp;&nbsp;";
		menuStr += "<a style=\"color:#00FFFF\" href=\"#\" onclick=\"javascript:seeLrcText('lrcdata')\">查看歌词</a>\n";
		menuStr += "<a style=\"color:#00FFFF\" href=\"#\" onclick=\"javascript:saveLrc('lrcdata')\">下载LRC歌词</a>\n";
		menuStr += "<a style=\"color:#00FFFF\" href=\""+MusicUrl+"\">下载歌曲</a>\n";
		menuStr += "</center>";
...
function saveLrc(lrc) { //函数:下载LRC歌词
...
function seeLrcText(obj) { //函数:查看歌词1
		 var lrcobj = document.getElementById(obj).innerHTML;
		 lrcobj = lrcobj.replace(/\[0.*?\]/gi, "" );
		 lrcobj = lrcobj.replace(/<!--/,'');
		 lrcobj = lrcobj.replace(/-->/,'');
		 lrcobj = lrcobj.replace(/\[ti:([^\[\]:]+)\]/i,"曲名:$1");
		 lrcobj = lrcobj.replace(/\[ar:([^\[\]:]+)\]/i,"歌手:$1");
		 lrcobj = lrcobj.replace(/\[al:([^\[\]:]+)\]/i,"专辑:$1");
		 lrcobj = lrcobj.replace(/\[by:([^\[\]:]+)\]/i,"编者:$1");
...
function seeLrcText2(obj) { //函数:查看歌词2
		 var lrcobj = document.getElementById(obj).innerHTML;
