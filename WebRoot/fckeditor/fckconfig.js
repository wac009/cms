...
/***********************新增的拓展插件*******************************/
FCKConfig.Plugins.Add( 'paragraph' , 'zh-cn,en' );
FCKConfig.Plugins.Add( 'Media','zh-cn');
FCKConfig.Plugins.Add( 'Attachment','zh-cn');

FCKConfig.Plugins.Add( 'dewplayer', 'zh-cn,en') ; //这里加入了 dewplayer mp3播放器 插件
FCKConfig.Plugins.Add( 'kmp','zh-cn,en') ;  //这里加入了 KMP MP3播放器 插件

FCKConfig.Plugins.Add( 'cutemp3','zh-cn,en' ) ; //这里加入了 CuteMP3 Player音乐播放器 插件
FCKConfig.Plugins.Add( 'fmplayer','zh-cn,en' ) ; //这里加入了 fmplayer mp3播放器 插件
FCKConfig.Plugins.Add( 'lrcshow', 'zh-cn,en') ; //这里加入了 歌词同步播放 插件

FCKConfig.Plugins.Add( 'insertcode' , 'zh-cn,en' ) ; //这里加入了 插入代码 插件
FCKConfig.Plugins.Add( 'highlighter', 'zh-cn,en' ) ; //这里加入了 插入高亮代码 插件
FCKConfig.Plugins.Add( 'runcode', 'zh-cn,en') ; //这里加入了 html运行代码 插件

FCKConfig.Plugins.Add( 'htmltiles','zh-cn,en') ; //这里加入了 插入HTML模板 插件
...
FCKConfig.Plugins.Add( 'symbol','zh-cn,en' ) ; //这里加入了 特殊字符 插件

FCKConfig.Plugins.Add( 'savehttpfiles','zh-cn,en');    //这里加入了 远程保存图片 插件
FCKConfig.Plugins.Add( 'imgmap', 'zh-cn,en') ; //这里加入了图像热区 插件
FCKConfig.Plugins.Add( 'highslide', 'zh-cn,en') ; //这里加入了 Highslide JS 插件
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['FontName','FontSize','TextColor','BGColor','Bold','Italic','Underline','StrikeThrough','Subscript','Superscript'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Acronym'],
	['Image','imgmapPopup','Flash','KMP','FileIcon','googlemaps','Table','Rule','Smiley','SpecialChar'],
	['PageBreak'],
	['FitWindow']
] ;
...
FCKConfig.ToolbarSets["Full"] = [
	...
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','Flash','Media','Smiley'],
	['KMP','CuteMp3','fmplayer','DewPlayer','LrcShow'],
	['InsertCode','HighLighter','-','RunCode'],
	['HtmlTiles','Acronym','FileIcon'],  
	['googlemaps'], /* Google Maps Plugin */
	['savehttpfiles','imgmapPopup','HighSlide'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor'],
	['FitWindow','ShowBlocks','-','PageBreak']	// No comma for the last row.
] ;
...
FCKConfig.FontNames		= '宋体;新宋体;黑体;隶书;幼圆;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
FCKConfig.FontSizes		= '12px;14px;16px;18px;20px;22px;24px;26px;28px;30px;36px;smaller;larger;xx-small;x-small;small;medium;large;x-large;xx-large' ;
