...
<#local editorBasePath="${base}/res/c/fckeditor/" filemanager="${editorBasePath}editor/filemanager/browser/default/browser.html"/>
var ${name} = new FCKeditor("${name}");
${name}.BasePath = "${editorBasePath}";
<#--
${name}.Config["CustomConfigurationsPath"]="${base}/res/c/fckeditor/myconfig.js?d="+new Date()*1;
-->
${name}.Config["CustomConfigurationsPath"]="${base}/res/c/fckeditor/myconfig.js";
