  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">资料中心用户类型管理 - 用户类型列表</span>
  	  		<span class="navi_f">
  	  			<a href='dataUserType_list.jspa' style="padding:0 5px;">刷新</a>
  	  			<a href='dataUserType_add.jspa' style="padding:0 5px;">添加</a>
  	  		</span>
  	  	</div>
  		<div class="mainData">
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>名称</th><th>级别</th><th>排序</th><th class="last">操作</th>
				</tr>
				</thead>
				...
				<s:iterator id="row" value="%{pagination.list}">
				  <tr name="tr_ids" onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
					...
					<td><s:property value="#row.rank"/></td>
					<td>
			    ...
			    <s:if test="%{pagination.list==null||pagination.list.size<=0}">
					<tr><td colspan="100" class="pn-lnoresult">没有数据！</td></tr>
				</s:if>
				</tbody>
				</s:if>
