  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">部门管理 - 部门列表</span>
  	  		<span class="navi_f">
  	  			<a href='dataDepartment_list.jspa' style="padding:0 5px;">刷新</a>
  	  			<a href='dataDepartment_add.jspa' style="padding:0 5px;">添加新部门</a>
  	  		</span>
  	  	</div>
  		<div class="mainData">
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>部门名称</th><th>级别</th><th>排序</th><th class="last">操作</th>
				</tr>
				</thead>
				...
				<s:iterator id="row" value="%{list}">
				  <tr name="tr_ids" onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
					...
					<td><s:property value="#row.selectTree"/></td>
					...
					<td class="pn-lopt">
						<a href="javascript:_operate(_add,'<s:property value="#row.id"/>')" class="pn-loperator" >
							<img src="<%=r_m%>/img/add.gif" alt="添加子部门" />
						</a> 
