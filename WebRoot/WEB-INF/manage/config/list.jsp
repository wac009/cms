	...
	<s:form action="config_systemUpdate_systemEdit" cssClass="vldform">
		...
		<table width="100%" class="table_edit">
			<tr>
				...
				<td class="content">
					<s:textfield name="config.contextPath" id="contextPath" cssClass="input required focus" />
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="config.port" id="port" cssClass="input required focus" />
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="config.defImg" id="defImg" cssClass="input required focus" />
			...
			<tr>
				...
				<td class="content">
					...
					<span class="red">*</span>&nbsp;&nbsp;&nbsp;
					附件地址
					<s:textfield name="config.dbFileUri" id="dbFileUri" cssClass="input required focus" />
