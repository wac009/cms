...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">模型管理 - 添加模型</span>
  		<span class="navi_f">
	...
	<s:form action="model_save_add" cssClass="vldform">
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					<s:radio name="model.disabled"  list="#{'true':'启用','false':'禁用 '}" listKey="key" listValue="value" />
				</td>
			</tr>
			<tr>
