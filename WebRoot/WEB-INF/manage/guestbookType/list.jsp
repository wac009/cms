  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">留言类别管理 - 列表</span>
  	  		<span class="navi_f">
  	  			<a href='guestbookType_list.jspa' style="padding:0 5px;">刷新</a>
  	  			<a href='guestbookType_add.jspa' style="padding:0 5px;">添加</a>
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>ID</th><th>名称</th><th>描述</th><th class="last">操作</th>
				</tr>
				</thead>
