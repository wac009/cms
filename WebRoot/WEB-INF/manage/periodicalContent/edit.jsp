...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">出版物管理 - 修改出版物</span></div>
	<div class="mainData">
		...
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					...
					<img id="preImg0" alt="预览区" noResize="true" srcRoot="${web.uploadUrl}" src="${web.uploadUrl}<s:property value="publication.imgPath"/>" style="width:80px;height:100px;background-color:#CCCCCC;border:1px solid #333"/>
					</div>
