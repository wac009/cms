...
<html>
  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">刊物管理 - 刊物列表</span></div>
  		<div class="mainData">
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>所属站点</th><th>刊物名称</th><th>英文名</th><th>排序</th><th>创建时间</th><th>期刊管理</th><th>状态</th><th class="last">操作</th>
				</tr>
				</thead>
				...
				<s:iterator id="row" value="%{list}" status="status">
				  <tr name="tr_ids" onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
					...
					<td><s:property value="#row.website.name"/></td>
					...
					<td><a href="periodical_list.jspa?publicationId=<s:property value="#row.id"/>">期刊管理</a></td>
