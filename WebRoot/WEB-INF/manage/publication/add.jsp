...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">杂志管理 - 添加杂志</span>
  		<span class="navi_f">
	...
	<s:form action="publication_save_add" cssClass="vldform" id="dataForm">
		<s:hidden name="publication.website.id" value="%{webId}"/>
