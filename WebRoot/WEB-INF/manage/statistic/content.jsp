  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">统计 - 内容统计</span>
  	  	</div>
  		<div class="mainData">
  		<div class="actInfo"><s:actionerror theme="ccweb"/><s:actionmessage theme="ccweb"/></div> 
  		<s:form  id="queryForm" action="statistic_content">
			...
			<input type="hidden" name="day"/>
	  		<div class="search">
				...
				<input type="radio" name="queryModel" id="qmday" value="day" onclick="chgModel(this.value);" <s:if test='statisticModel.toString()=="day"'>checked="checked"</s:if> /><label for="qmday">日报表</label>
	  			发布者<s:textfield name="queryUsername" cssClass="input" style="width:70px"/>
	  			栏目<s:select name="channelId" list="channelList" listKey="id" listValue="selectTree" cssClass="select" />
