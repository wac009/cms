  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">资料类型管理 -类型列表</span>
  	  		<span class="navi_f">
  	  			<a href='dataInfoType_list.jspa' style="padding:0 5px;">刷新</a>
  	  			<a href='dataInfoType_add.jspa' style="padding:0 5px;">添加</a>
  	  		</span>
  	  	</div>
  		<div class="mainData">
