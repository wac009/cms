...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h"><a href="#">模板管理 - 修改模板文件</a></span></div>
	<div class="mainData">
	<div class="actInfo">
		...
		<table width="100%" class="table_edit">
			...
			<tr>
				<td class="content" colspan="2">
					<s:textarea name="tplContent" id="tplContent" cssClass="input txtArea" cssStyle="width:99%;height:550px;"></s:textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
...
function ajaxSubmit() {
	$.postJson('ajax/template_fileupdate.jspa', {
		'tplName' : $('#tplName').val(),
