...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h"><a href="#">模板管理 - 修改模板</a></span></div>
	<div class="mainData">
	<jsp:include page="importTplInc.jsp" />
	<jsp:include page="../common/imgUpload.jsp" />
	<div class="actInfo"><s:actionerror theme="ccweb"/><s:actionmessage theme="ccweb"/></div>
	<s:form action="template_update_edit" cssClass="vldform">
		<s:hidden name="id" />
			...
			<tr>
				...
				<td class="content">
					...
					<div class="float_left" style="margin-left:15px;">
						<img id="preImg0" alt="预览区" onerror="javascript:this.src='<%=r_m%>/img/defaultpic.gif'"  noResize="true" srcRoot="${web.uploadPath}" src="${web.uploadPath}<s:property value="template.imgPath"/>" style="width:100px;height:100px;background-color:#CCCCCC;border:1px solid #333"/>
					</div>
				</td>
			</tr>
			<tr>
