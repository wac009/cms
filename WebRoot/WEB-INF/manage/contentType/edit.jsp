...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h"><a href="#">内容类型管理 - 修改内容类型</a></span></div>
	<div class="mainData">
	<div class="actInfo"><s:actionerror theme="ccweb"/><s:actionmessage theme="ccweb"/></div> 
	<s:form action="contentType_update_edit" cssClass="vldform">
		<s:hidden name="id" />
		<s:hidden name="contentType.id" />
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					...
					<s:if test="contentType.hasImage">
						<span class="imgW">图片宽<s:textfield name="contentType.imgWidth" cssClass="input " cssStyle="width:60px;"/></span>
						<span class="imgH">图片高<s:textfield name="contentType.imgHeight" cssClass="input " cssStyle="width:60px;"/></span>	
					</s:if>
					<s:else>
			...
			<tr>
				...
				<td class="content">
					有媒体<s:checkbox name="contentType.hasMedia"  />
				</td>
			</tr>
			<tr>
