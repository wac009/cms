...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">站点管理 - 添加</span></div>
	<div class="mainData">
	<div class="actInfo"><s:actionerror theme="ccweb"/><s:actionmessage theme="ccweb"/></div>
	<s:form action="website_save_add" cssClass="vldform">
		<table width="100%" class="table_edit">
			...
			<%--<tr>
				...
				<td class="content"><s:textfield name="website.area.id" cssClass="input" /></td>
			</tr>--%>
			<tr>
			...
			<tr>
				...
				<td class="content">
					...
					动态页后缀：<s:select list="#{'.jhtml':'.jhtml','.jspa':'.jspa','.jsp':'.jsp','.html':'.html'}" name="website.dynamicSuffix" cssClass="select" cssStyle="width:100px;" ></s:select>
			...
			<tr>
				...
				<td class="content">
					...
					后台本地化：<s:textfield name="website.localeAdmin" id="localeAdmin" cssClass="input"  value="zh_CN"/>
					前台本地化：<s:textfield name="website.localeFront" id="localeFront" cssClass="input"  value="zh_CN"/>  
				</td>
			</tr>
			<tr>
				<td class="label">版权信息：</td>
				<td class="content">
					<s:textfield name="website.copyright" id="copyright" cssClass="input required" /><span class="red">*</span>
					<s:fielderror fieldName="website.copyright" theme="ccweb"/>
					备案号：<s:textfield name="website.recordCode" id="recordcode" cssClass="input required" /><span class="red">*</span>
					<s:fielderror fieldName="website.recordCode" theme="ccweb"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content">
					状态：<s:radio name="website.close" list="#{'false':'开启','true':'关闭'}" listKey="key" listValue="value" value="false"/>&nbsp;&nbsp;
					回收站：<s:radio name="website.resycleOn" list="#{'true':'开启','false':'关闭'}" listKey="key" listValue="value" value="false"/>&nbsp;&nbsp;
					使用相对路径：<s:radio name="website.relativePath" list="#{'true':'是','false':'否'}" listKey="key" listValue="value" value="false"/><span class=" help">只适于单站点</span>&nbsp;&nbsp;
					开启静态首页：<s:radio name="website.staticIndex" list="#{'true':'开启','false':'关闭'}" listKey="key" listValue="value" value="true"/>
				</td>
			</tr>
			<tr>
				<td class="label">审核设置：</td>
				<td class="content">
					终审级别：<s:textfield name="website.finalStep" id="finalStep" cssClass="input required" value="2"/>
			...
			<tr>
				...
				<td class="content"><s:checkboxlist list="roleList" listKey="id" listValue="name" name="roles.id" /></td>
			</tr>
			<tr>
				...
				<td class="content">
					...
					手机：<s:textfield name="website.ownerMobile" cssClass="input" />
				</td>
			</tr>
			<tr>
				<td colspan="2">
