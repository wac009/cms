  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">内容Tag管理 - 列表</span>
  	  		<span class="navi_f">
  	  			<a href='contentTag_list.jspa' style="padding:0 5px;">刷新</a>
  		...
  		<s:form id="add" action="contentTag_save_add" cssClass="search">
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>ID</th><th>名称</th><th>文档数</th><th class="last">操作</th>
				</tr>
				</thead>
...
function rename(o,id){
	...
	$.postJson('ajax/contentTag_rename.jspa', {
		'name' : $(o).val(),
		'id':id
	}, function(data) {
		if (data.success) {
