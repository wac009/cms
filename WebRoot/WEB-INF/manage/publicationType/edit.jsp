...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">杂志类型管理 - 修改类型</span>
  		<span class="navi_f">
	...
	<s:form action="publicationType_update_edit" cssClass="vldform">
		<s:hidden name="id" />
		<s:hidden name="type.id" />
		<s:hidden name="type.website.id" />
