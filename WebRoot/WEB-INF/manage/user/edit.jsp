...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span>
  		<span class="navi_h"><a href="#">管理员管理 - 修改管理员资料</a></span>
  		<span class="navi_f">
	...
	<s:form action="user_update_edit" cssClass="vldform">
		...
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					<s:password name="password" id="password" cssClass="input" showPassword="true" />
					<s:fielderror fieldName="password" theme="ccweb"/>
					确认密码：
					<s:password name="confirm_password" id="confirm_password" cssClass="input" equalTo="#password" showPassword="true" />
			...
			<tr>
				...
				<td class="content">
					手机：<s:textfield name="user.ext.mobile" id="mobile" cssClass="input" cssStyle="width:160px;" />
					电话：<s:textfield name="user.ext.tel" id="tel" cssClass="input" cssStyle="width:160px;" />
					传真：<s:textfield name="user.ext.fax" id="fax" cssClass="input" cssStyle="width:160px;" /><br/>
					地址：<s:textfield name="user.ext.address" id="address" cssClass="input"  cssStyle="width:360px;"/>
					邮编：<s:textfield name="user.ext.zip" id="zip" cssClass="input" cssStyle="width:100px;" />
				</td>
			</tr>
			<tr id="titImgDiv">
			...
			<tr>
				...
				<td class="content">
					<s:checkboxlist list="roleList" listKey="id" listValue="name" name="roles.id" value="user.roles.{id}"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content-tree">
					...
					<s:else>
						<s:checkbox name="allChannel" id="allChannel" onclick="disChannels(this.checked);"/>
						<label for="allChannel">拥有所有栏目</label>
						<s:component template="tree.ftl" theme="ccweb">
							...
							<s:param name="valueContent" value="user.channels.{id}"/>
						</s:component>
					</s:else>
				</td>
			</tr>
