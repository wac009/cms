...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">栏目管理 - 添加栏目</span>
  		<span class="navi_f">
	...
	<s:form action="channel_save_add" cssClass="vldform">
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="channel.ext.title" cssClass="input" value=""/>
					<span class="help">搜索引擎优化title部分</span>
					meta关键字：
					<s:textfield name="channel.ext.keywords" cssClass="input" value=""/>
			...
			<tr>
				...
				<td class="content">
					<s:textarea name="channel.ext.description" cssClass="input txtArea" value=""/>
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="channel.ext.finalStep" id="finalStep" cssClass="input"  value="2"/>
			...
			<tr>
				...
				<td class="content">
					<s:checkbox name="channel.ext.disabled" id="channel_isdisabled" value="false"/><label for="channel_isdisabled">关闭</label>
					<s:checkbox name="channel.ext.display" id="channel_isdisplay" value="true"/><label for="channel_isdisplay">显示</label>
					<s:checkbox name="channel.ext.blank" id="channel_blank" value="true"/><label for="channel_blank">新窗口打开</label>
					评论：<s:radio name="channel.ext.commentControl"  list="#{'0':'游客评论','1':'登录评论 ','2':'关闭评论 '}" listKey="key" listValue="value" value="0" />
					顶踩：<s:radio name="channel.ext.allowUpdown"   list="#{'true':'启用','false':'禁用 '}" listKey="key" listValue="value" value="true" />
				</td>
			</tr>
			<tr>
