...
<html>
  ...
  <body>
	  <div id="main_left" >
	     <h4><span>资料中心</span></h4>
	     <div class="inner">
	     	<div class="lttop">
				<a href="javascript:location.reload()" class="inline_block" style="padding:0 5px;">刷新目录</a>
				<hr style="height:1px;background:#ccc;margin:0;"/>
			</div>	     	
	        <div id="tree_box">
	             <div id="tree" class="tree p_a" style="top:34px;overflow:auto;overflow-x:hidden;">
	                <s:if test="leftMenu==null||leftMenu.id==null"><ul class="leftMenu_ul" style="padding:20px 0 0 25px;"><li>【菜单为空】</li></ul></s:if>
					<s:else>
				 		<ul class="leftMenu_ul">
	                  		<s:iterator id="leftMenu" value="leftMenus">
								...
								<a href="<s:property value="#leftMenu.url"/>.jspa" target="mainFrame"><s:property value="#leftMenu.name"/></a>
								</li>
	                  		</s:iterator>
	                  	</ul>
					</s:else>
