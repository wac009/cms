					...
					<s:iterator id="row" value="%{pagination.list}">
					  <tr name="tr_ids" onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						...
						<td class="pn-lopt">
						    ...
						    <a href="message_reply.jspa?id=<s:property value="#row.id"/>" class="pn-loperator" >回复</a>
						    <a href="message_forward.jspa?id=<s:property value="#row.id"/>&mf=0" class="pn-loperator" >转发</a>
						    <a href="message_trash.jspa?id=<s:property value="#row.id"/>" class="pn-loperator" >删除到垃圾箱</a>
