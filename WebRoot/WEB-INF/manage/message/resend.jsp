...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">站内信管理 - 重发站内信</span>
  		<span class="navi_f">
	...
	<s:form action="message_tosend_sendbox" cssClass="vldform" id="dataForm">
		<s:hidden name="id"/>
		<table width="100%" class="table_edit">
			<tr>
				<td class="label">收件人：</td>
				<td class="content">
					<s:select name="uid" list="users" listKey="id" listValue="username" value="%{message.msgReceiverUser.id}" cssClass="select focus" />
					会员组选择:
...
<script type="text/javascript">
	function saveDraft(){
		...
		dataForm.action = "message_saveDraft_draftbox.jspa";
		dataForm.submit();
	}
</script>