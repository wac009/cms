  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">站内信管理 - 发件箱</span>
  	  		<span class="navi_f">
	  	  		<a href='message_sendbox.jspa' style="padding:0 5px;">刷新</a>
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>ID</th><th>标题</th><th>收件人</th><th>发送时间</th><th>状态</th><th class="last">操作</th>
				</tr>
				</thead>
				...
				<tbody class="pn-ltbody">
					<s:iterator id="row" value="%{pagination.list}">
					  <tr name="tr_ids" onmouseover="Pn.LTable.lineOver(this);" onmouseout="Pn.LTable.lineOut(this);" onclick="Pn.LTable.lineSelect(this);">
						...
						<td><s:property value="#row.msgReceiverUser.username"/></td>
						...
						<td class="pn-lopt">
						    <a href="message_read.jspa?id=<s:property value="#row.id"/>&mf=1" class="pn-loperator" >查看</a>
						    <a href="message_forward.jspa?id=<s:property value="#row.id"/>&mf=1">转发</a>
