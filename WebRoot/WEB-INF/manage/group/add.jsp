...
<html>
  ...
  <body>
	...
	<s:form action="group_save_add" cssClass="vldform" id="dataForm">
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					默认组：<s:radio list="#{'1':'是','0':'否'}" listKey="key" listValue="value" name="group.regDef" value="0"></s:radio>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					评论需要审核：<s:radio list="#{'1':'需要','0':'不需要'}" listKey="key" listValue="value" name="group.needCheck" value="1"></s:radio>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					评论需要验证码：<s:radio list="#{'1':'需要','0':'不需要'}" listKey="key" listValue="value" name="group.needCaptcha" value="1"></s:radio>
				</td>
			</tr>
			<tr>
				<td colspan="2">
