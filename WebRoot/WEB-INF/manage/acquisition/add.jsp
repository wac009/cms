...
<html>
  ...
  <body>
  	<div class="navi"><span class="navi_b">当前位置:</span><span class="navi_h">信息采集管理 - 添加采集条目</span></div>
	<div class="mainData">
	<div class="actInfo"><s:actionerror theme="ccweb"/><s:actionmessage theme="ccweb"/></div>
	<s:form action="acquisition_save_add" cssClass="vldform">
		<table width="100%" class="table_edit">
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="acquisition.pageEncoding" id="pageEncoding" value="GBK" cssClass="input required" />
			...
			<tr>
				...
				<td class="content">
					<s:textfield name="acquisition.pauseTime" id="pauseTime" value="500" cssClass="input required" />(毫秒)
					<s:fielderror fieldName="acquisition.pauseTime" theme="ccweb"/>
					<span class="red">*</span>
					<span class="help">每采集一篇文章暂停时间</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content">
					...
					<s:textfield name="acquisition.dynamicStart" id="dynamicStart" value="2" cssStyle="width:50px;" cssClass="input" />到
					<s:textfield name="acquisition.dynamicEnd" id="dynamicEnd" value="10" cssStyle="width:50px;" cssClass="input" />
				</td>
			</tr>
			<tr>
