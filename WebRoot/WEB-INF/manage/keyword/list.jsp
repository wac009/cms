  ...
  <body>
  	<div id="container">
  	  	<div class="navi"><span class="navi_b">当前位置:</span>
  	  		<span class="navi_h">关键词管理 - 列表</span>
  	  		<span class="navi_f">
  	  			<a href='keyword_list.jspa' style="padding:0 5px;">刷新</a>
  	  			<a href='keyword_add.jspa' style="padding:0 5px;">添加</a>
  		...
  		<s:form id="dataForm">
	  		...
	  		<div class="data">
				...
				<tr>
					...
					<th>ID</th><th>关键词</th><th>替换内容</th><th>状态</th><th class="last">操作</th>
				</tr>
				</thead>
