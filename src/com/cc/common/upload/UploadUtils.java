...
import com.cc.common.util.Num62;
...
public class UploadUtils {
	 ...
	 * href="http://docs.fckeditor.net/FCKeditor_2.x/Developers_Guide/Server_Side_Integration#File_Browser_Requests" target="_blank">rules</a>.
	 * 
	 ...
	 * This method extracts a file's base name, iterates over it until the first non-existent appearance with <code>basename(n).ext</code>. Where n is
	 * a positive integer starting from one.
	 * 
