...
public class SimpleFreeMarkerView extends AbstractTemplateView {
	...
	protected FreeMarkerConfig autodetectConfiguration() throws BeansException {
		try {
			return BeanFactoryUtils.beanOfTypeIncludingAncestors(getApplicationContext(), FreeMarkerConfig.class, true, false);
	 ...
	 * <p>
	 * Checks that the template for the default Locale can be found: FreeMarker will check non-Locale-specific templates if a locale-specific one is
	 * not found.
	 * 
