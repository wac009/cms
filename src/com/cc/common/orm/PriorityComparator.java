...
public class PriorityComparator implements Comparator<IPriorityInterface>, Serializable {
	private static final long serialVersionUID = -6454333527227543298L;
	public static final PriorityComparator INSTANCE = new PriorityComparator();

	@Override
	public int compare(IPriorityInterface o1, IPriorityInterface o2) {
