package com.cc.common.orm.hibernate4;
...
public final class SpringEhCacheProvider implements CacheProvider{
	...
	public final void start(Properties properties) throws CacheException {
		if (manager != null) {
			String s = "Attempt to restart an already started EhCacheProvider. Use sessionFactory.close() " + " between repeated calls to buildSessionFactory. Using previously created EhCacheProvider."
