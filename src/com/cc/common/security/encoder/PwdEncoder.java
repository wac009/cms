...
public class PwdEncoder implements IPwdEncoder {
	 ...
	 * using {@link #mergePasswordAndSalt(String,Object,boolean)}.
	 * <p>
	 * The first element in the returned array is the password. The second element is the salt. The
	 * salt array element will always be present, even if no salt was found in the
	 * <code>mergedPasswordSalt</code> argument.
	 * </p>
	 * 
	 ...
	 * @param salt
	 */
	public void setSalt(String defaultSalt) {
