...
/**
 * This is an object that contains data related to the jo_user table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="jo_user"
 */
public abstract class BaseUnifiedUser implements Serializable {

	private static final long	serialVersionUID		= -2025700482657542370L;
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.core.entity.UnifiedUser))
			return false;
		else {
			com.cc.core.entity.UnifiedUser unifiedUser = (com.cc.core.entity.UnifiedUser) obj;
