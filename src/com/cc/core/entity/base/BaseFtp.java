...
/**
 * This is an object that contains data related to the jo_ftp table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="jo_ftp"
 */
public abstract class BaseFtp implements Serializable {

	private static final long	serialVersionUID	= 9199136053708351312L;
	 ...
	 */
	public BaseFtp(java.lang.Integer id, java.lang.String name, java.lang.String ip, java.lang.Integer port, java.lang.String encoding,
	 ...
	 * 
	 * @hibernate.id generator-class="identity" column="ftp_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.core.entity.Ftp))
			return false;
		else {
			com.cc.core.entity.Ftp ftp = (com.cc.core.entity.Ftp) obj;
			if (null == this.getId() || null == ftp.getId())
				return false;
			else
				return (this.getId().equals(ftp.getId()));
		}
	}
