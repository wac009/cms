...
/**
 * This is an object that contains data related to the jo_upload table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="jo_upload"
 */
public abstract class BaseDbFile implements Serializable {

	private static final long	serialVersionUID	= 7500764262588159189L;
	 ...
	 */
	public BaseDbFile(java.lang.String id, java.lang.Integer length, java.lang.Long lastModified, byte[] content) {
		this.setId(id);
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="filename"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.core.entity.DbFile))
			return false;
		else {
			com.cc.core.entity.DbFile dbFile = (com.cc.core.entity.DbFile) obj;
			if (null == this.getId() || null == dbFile.getId())
				return false;
			else
				return (this.getId().equals(dbFile.getId()));
		}
	}
