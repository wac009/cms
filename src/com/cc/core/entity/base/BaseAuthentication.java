...
/** This is an object that contains data related to the jo_authentication table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="core_authentication" */
public abstract class BaseAuthentication implements Serializable {

	private static final long	serialVersionUID	= 3697698522173007474L;
	...
	public BaseAuthentication(java.lang.String id, java.lang.Integer uid, java.lang.String username, java.util.Date loginTime,
			java.lang.String loginIp, java.util.Date updateTime) {
		this.setId(id);
		this.setUid(uid);
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="authentication_id" */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.core.entity.Authentication))
			return false;
		else {
			com.cc.core.entity.Authentication authentication = (com.cc.core.entity.Authentication) obj;
