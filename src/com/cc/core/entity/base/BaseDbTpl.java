...
/**
 * This is an object that contains data related to the jo_template table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="jo_template"
 */
public abstract class BaseDbTpl implements Serializable {

	private static final long	serialVersionUID	= -4896835669210946670L;
	 ...
	 */
	public BaseDbTpl(java.lang.String id, long lastModified, boolean directory) {
		this.setId(id);
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="tpl_name"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.core.entity.DbTpl))
			return false;
		else {
			com.cc.core.entity.DbTpl dbTpl = (com.cc.core.entity.DbTpl) obj;
			if (null == this.getId() || null == dbTpl.getId())
				return false;
			else
				return (this.getId().equals(dbTpl.getId()));
		}
	}
