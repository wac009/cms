...
import static com.cc.core.action.front.LoginAct.MESSAGE;
import static com.cc.core.action.front.LoginAct.PROCESS_URL;
import static com.cc.core.action.front.LoginAct.RETURN_URL;
import static com.cc.core.service.IAuthenticationSvc.AUTH_KEY;
...
import com.cc.common.security.BadCredentialsException;
import com.cc.common.security.DisabledException;
import com.cc.common.security.UsernameNotFoundException;
import com.cc.common.web.CookieUtils;
import com.cc.common.web.RequestUtils;
import com.cc.common.web.session.ISessionProvider;
import com.cc.core.entity.Authentication;
import com.cc.core.entity.CoreConfig.ConfigLogin;
import com.cc.core.service.IAuthenticationSvc;
import com.cc.core.service.ICoreConfigSvc;
...
public class CasLoginAct {
		...
		if (authId != null) {
			...
			if (auth != null) {
				...
				if (view != null) {
					...
					return FrontUtils.getTplPath(request, sol, TPLDIR_MEMBER, LOGIN_STATUS);
				}
			}
		}
		FrontUtils.frontData(request, model, site);
	...
	public String submit(String username, String password, String captcha, String processUrl, String returnUrl, String message, HttpServletRequest request,
		...
		if (!errors.hasErrors()) {
			try {
				...
				User user = cmsUserMng.findById(auth.getUid());
				if (user.getDisabled()) {
					// 如果已经禁用，则推出登录。
	...
	private WebErrors validateSubmit(String username, String password, String captcha, Integer errorRemaining, HttpServletRequest request,
