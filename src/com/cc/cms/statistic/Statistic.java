...
public class Statistic {
	...
	public Statistic(String description, Long count) {
		this(count);
		this.description = description;
	}

	public Statistic(String description, Long count, Long total) {
	 ...
	 * 统计模式
	 */
	public static enum StatisticModel {
		/**
		 * 日统计
		 */
		day,
	...
	public String getPercent() {
		return NumberFormat.getPercentInstance().format(count / (total == 0 ? 1.0 : total + 0.0));
	}

	public String getBarWidth() {
		return (int) ((Integer.parseInt(getPercent().replace(PERCENTSIGN, ""))) * COEFFICIENT) + PERCENTSIGN;
	}
}
