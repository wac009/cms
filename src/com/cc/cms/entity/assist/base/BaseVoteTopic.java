...
/**
 * This is an object that contains data related to the cms_vote_topic table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_vote_topic"
 */
public abstract class BaseVoteTopic implements Serializable {

	private static final long	serialVersionUID		= 8411492941227514533L;
	...
	public BaseVoteTopic(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}

	/** Constructor for required fields */
	public BaseVoteTopic(java.lang.Integer id, com.cc.cms.entity.main.Site site, java.lang.String title, java.lang.Integer totalCount,
	...
	// collections
	private java.util.Set<com.cc.cms.entity.assist.VoteItem>	items;
	private java.util.Set<com.cc.cms.entity.assist.VoteRecord>	records;
	...
	public java.util.Set<com.cc.cms.entity.assist.VoteItem> getItems() {
		return items;
	}
	 ...
	 *            the items value
	 */
	public void setItems(java.util.Set<com.cc.cms.entity.assist.VoteItem> items) {
		this.items = items;
	}

	public java.util.Set<com.cc.cms.entity.assist.VoteRecord> getRecords() {
		return records;
	}

	public void setRecords(java.util.Set<com.cc.cms.entity.assist.VoteRecord> records) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.assist.VoteTopic))
			return false;
		else {
			com.cc.cms.entity.assist.VoteTopic voteTopic = (com.cc.cms.entity.assist.VoteTopic) obj;
			if (null == this.getId() || null == voteTopic.getId())
				return false;
			else
				return (this.getId().equals(voteTopic.getId()));
		}
	}
