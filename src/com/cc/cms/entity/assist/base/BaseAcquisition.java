...
/**
 * This is an object that contains data related to the cms_acquisition table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_acquisition"
 */
public abstract class BaseAcquisition implements Serializable {
	private static final long	serialVersionUID		= 5946857138672371041L;
	public static String		REF						= "Acquisition";
	...
	// constructors
	public BaseAcquisition() {
		initialize();
	}
	/** Constructor for primary key */
	public BaseAcquisition(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	/** Constructor for required fields */
	public BaseAcquisition(java.lang.Integer id, com.cc.cms.entity.main.User user, com.cc.cms.entity.main.ContentType type,
			com.cc.cms.entity.main.Site site, com.cc.cms.entity.main.Channel channel, java.lang.String name, java.lang.Integer status,
			java.lang.Integer currNum, java.lang.Integer currItem, java.lang.Integer totalItem, java.lang.Integer pauseTime,
			java.lang.String pageEncoding, java.lang.Integer queue) {
		this.setId(id);
		this.setUser(user);
		this.setType(type);
		this.setSite(site);
	...
	private com.cc.cms.entity.main.ContentType	type;
	...
	public com.cc.cms.entity.main.ContentType getType() {
		return type;
	}
	/**
	 ...
	 *            the type_id value
	 */
	public void setType(com.cc.cms.entity.main.ContentType type) {
		this.type = type;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.assist.Acquisition))
			return false;
		else {
			com.cc.cms.entity.assist.Acquisition acquisition = (com.cc.cms.entity.assist.Acquisition) obj;
			if (null == this.getId() || null == acquisition.getId())
				return false;
			else
				return (this.getId().equals(acquisition.getId()));
		}
	}
	@Override
	public int hashCode() {
