...
/**
 * This is an object that contains data related to the cms_acquisition_temp table. Do not modify
 * this class because it will be overwritten if the configuration file related to this class is
 * modified.
 * 
 * @hibernate.class table="cms_acquisition_temp"
 */
public abstract class BaseAcquisitionTemp implements Serializable {
	private static final long	serialVersionUID	= 6081599034303192442L;
	public static String		REF					= "AcquisitionTemp";
	...
	// constructors
	public BaseAcquisitionTemp() {
		initialize();
	}
	/**
	 * Constructor for primary key
	 */
	public BaseAcquisitionTemp(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	/**
	 ...
	 */
	public BaseAcquisitionTemp(java.lang.Integer id, java.lang.String channelUrl, java.lang.String contentUrl,
			java.lang.Integer percent, java.lang.String description, java.lang.Integer seq) {
		this.setId(id);
	 ...
	 * 
	 * @hibernate.id generator-class="identity" column="temp_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.assist.AcquisitionTemp))
			return false;
		else {
			com.cc.cms.entity.assist.AcquisitionTemp acquisitionTemp = (com.cc.cms.entity.assist.AcquisitionTemp) obj;
			if (null == this.getId() || null == acquisitionTemp.getId())
				return false;
			else
				return (this.getId().equals(acquisitionTemp.getId()));
		}
	}
	@Override
	public int hashCode() {
