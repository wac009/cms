...
public class ContentCheck extends BaseContentCheck {
	...
	/** 采集 */
	public static final byte	ACQUISITION			= 4;
	...
	public ContentCheck(java.lang.Integer id, java.lang.Byte checkStep, java.lang.Boolean rejected) {
		super(id, checkStep, rejected);
	}
