...
public class ChannelExt extends BaseChannelExt {
	...
	public ChannelExt(java.lang.Integer id, java.lang.String name, java.lang.Boolean staticChannel, java.lang.Boolean staticContent,
		...
		super(id, name, staticChannel, staticContent, accessByDir, listChild, pageSize, hasTitleImg, hasContentImg, titleImgWidth, titleImgHeight,
				contentImgWidth, contentImgHeight, commentControl, blank, hasContent, display);
	}
