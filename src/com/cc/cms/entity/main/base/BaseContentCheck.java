...
/**
 * This is an object that contains data related to the cms_content_check table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_content_check"
 */
public abstract class BaseContentCheck implements Serializable {

	private static final long	serialVersionUID	= -7609689485618946346L;
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.ContentCheck))
			return false;
		else {
			com.cc.cms.entity.main.ContentCheck contentCheck = (com.cc.cms.entity.main.ContentCheck) obj;
