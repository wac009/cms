...
/** This is an object that contains data related to the cms_model table. Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="cms_model" */

public abstract class BaseModel implements Serializable {

	private static final long	serialVersionUID		= -3533691475377798559L;
	public static String		REF						= "Model";
	...
	public BaseModel(java.lang.Integer id, java.lang.String name, java.lang.String path, java.lang.Integer titleImgWidth,
	...
	// collections
	private java.util.Set<com.cc.cms.entity.main.ModelItem>	items;
	...
	public java.util.Set<com.cc.cms.entity.main.ModelItem> getItems() {
		return items;
	}
	...
	public void setItems(java.util.Set<com.cc.cms.entity.main.ModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.Model))
			return false;
		else {
			com.cc.cms.entity.main.Model model = (com.cc.cms.entity.main.Model) obj;
