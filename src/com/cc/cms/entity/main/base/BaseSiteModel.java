...
/**
 * This is an object that contains data related to the cms_site_model table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_site_model"
 */
public abstract class BaseSiteModel implements Serializable {
	private static final long	serialVersionUID	= 4744725439652342219L;
	public static String		REF					= "SiteModel";
	...
	public BaseSiteModel(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	/** Constructor for required fields */
	public BaseSiteModel(java.lang.Integer id, java.lang.String field, java.lang.String label, java.lang.Integer priority) {
		this.setId(id);
		this.setField(field);
		this.setLabel(label);
	 ...
	 * 
	 * @hibernate.id generator-class="identity" column="model_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.SiteModel))
			return false;
		else {
			com.cc.cms.entity.main.SiteModel siteModel = (com.cc.cms.entity.main.SiteModel) obj;
			if (null == this.getId() || null == siteModel.getId())
				return false;
			else
				return (this.getId().equals(siteModel.getId()));
		}
	}
	@Override
	public int hashCode() {
