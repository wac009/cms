...
/**
 * This is an object that contains data related to the cms_config table. Do not modify this class
 * because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_config"
 */
public abstract class BaseConfig implements Serializable {

	private static final long	serialVersionUID		= 6059632439943760235L;
	 ...
	 */
	public BaseConfig(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseConfig(java.lang.Integer id, java.lang.String dbFileUri, java.lang.Boolean uploadToDb, java.lang.String defImg, java.lang.String loginUrl,
			java.util.Date countClearTime, java.util.Date countCopyTime, java.lang.String downloadCode, java.lang.Integer downloadTime) {
		this.setId(id);
	...
	// components
	com.cc.cms.entity.main.MarkConfig							m_markConfig;
	com.cc.cms.entity.main.EmailConfig							m_emailConfig;
	// collections
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="config_id"
	 */
	 ...
	 * 
	 * @param countClearTime
	 *            the count_clear_time value
	 */
	 ...
	 * 
	 * @param downloadTime
	 *            the download_time value
	 */
	public void setDownloadTime(java.lang.Integer downloadTime) {
		this.downloadTime = downloadTime;
	}

	public com.cc.cms.entity.main.MarkConfig getMarkConfig() {
		return m_markConfig;
	}
	 ...
	 * 
	 * @param m_markConfig
	 *            the ${prop.Column} value
	 */
	public void setMarkConfig(com.cc.cms.entity.main.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}

	public com.cc.cms.entity.main.EmailConfig getEmailConfig() {
	 ...
	 *            the ${prop.Column} value
	 */
	public void setEmailConfig(com.cc.cms.entity.main.EmailConfig m_emailConfig) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.Config))
			return false;
		else {
			com.cc.cms.entity.main.Config config = (com.cc.cms.entity.main.Config) obj;
