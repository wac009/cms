...
/** This is an object that contains data related to the cms_model_item table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_model_item" */

public abstract class BaseModelItem implements Serializable {

	private static final long	serialVersionUID	= 3047146441878426552L;
	public static String		REF					= "ModelItem";
	...
	public BaseModelItem(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}

	/** Constructor for required fields */
	public BaseModelItem(java.lang.Integer id, com.cc.cms.entity.main.Model model, java.lang.String field, java.lang.String label,
			java.lang.Integer dataType, java.lang.Boolean single, java.lang.Boolean channel, java.lang.Boolean custom, java.lang.Boolean display) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.ModelItem))
			return false;
		else {
			com.cc.cms.entity.main.ModelItem modelItem = (com.cc.cms.entity.main.ModelItem) obj;
			if (null == this.getId() || null == modelItem.getId())
				return false;
			else
				return (this.getId().equals(modelItem.getId()));
		}
	}
