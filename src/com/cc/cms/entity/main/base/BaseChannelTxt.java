...
/**
 * This is an object that contains data related to the cms_channel_txt table. Do not modify this
 * class because it will be overwritten if the configuration file related to this class is modified.
 * 
 * @hibernate.class table="cms_channel_txt"
 */
public abstract class BaseChannelTxt implements Serializable {

	private static final long	serialVersionUID	= -3229765553410311148L;
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.cc.cms.entity.main.ChannelTxt))
			return false;
		else {
			com.cc.cms.entity.main.ChannelTxt channelTxt = (com.cc.cms.entity.main.ChannelTxt) obj;
