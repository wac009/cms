 ...
 */
@Repository
public class MessageDaoImpl extends CmsDaoImpl<Message> implements IMessageDao {
	...
	public long getCountByTimeRange(Integer siteId, TimeRange timeRange) {
		Finder f = createCacheableFinder("select count(*) from Message bean");
